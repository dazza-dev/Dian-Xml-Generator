...
class DocumentBuilder
{
    ...
    public function __construct(string $documentType, array $documentData, string|int $environment, array $software)
    {
        ...
        if ($this->document instanceof Invoice) {
            ...
            // Due date
            if (isset($this->documentData['due_date'])) {
                $this->document->setDueDate($this->documentData['due_date']);
            }
        }
        ...
        // Payment mean
        $this->document->setPaymentMean($this->documentData['payment_mean']);
        $this->document->setPayments($this->documentData['payments']);
     ...
     * Get document model
     */
    private function documentModel(): Invoice|CreditNote|DebitNote
    {
     ...
     * Get document
     */
    public function getDocument(): Invoice|CreditNote|DebitNote
    {
